...
const movies = [
    ...
    let currentIndex = 1; // default selection
    ...
    // Default render second movie
// after you populate movieSelect, filters, THEATRES, SLOTS, and attach listeners
const DEFAULT_MOVIE_INDEX = 1; // 1 => second movie
renderMovie(DEFAULT_MOVIE_INDEX);
movieSelect.value = DEFAULT_MOVIE_INDEX;
